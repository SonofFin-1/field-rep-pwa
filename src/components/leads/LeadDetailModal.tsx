...
import { X, Navigation, ExternalLink, Mic, MicOff, Send, Trash2 } from 'lucide-react'
...
export function LeadDetailModal({ lead, onClose }: LeadDetailModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-[400px] max-h-[80vh] bg-white rounded-[14px] shadow-xl flex flex-col overflow-hidden">
        {/* Header */}
        ...
        {/* Action Button */}
        <div className="flex items-center gap-3 px-4 py-3 border-b border-[#DFEBF4]">
          <a
